package com.lb.mobile.comm.util;
...
public class DateUtil {
     ...
     * @return  date1>date2时结果<0,  date1=date2时结果=0, date2>date1时结果>0
     */
    public static int secondBetweenByDateStr(String date1, String date2) {
        DateFormat sdf=new SimpleDateFormat("yyyyMMddHHmmss");
        Calendar cal = Calendar.getInstance();
        try {
    ...
    public static boolean belongCalendar(String time, String from, String to) throws ParseException {
        ...
        Calendar after = Calendar.getInstance();
        after.setTime(sdf.parse(from));

        Calendar before = Calendar.getInstance();
        before.setTime(sdf.parse(to));
    ...
    public static void main(String [] args){
        try {
            System.out.println(getDayWeekOfDate1(new Date()));
            System.out.println(getDayWeekOfDate2(new Date()));
        } catch (Exception e) {
